      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              href="/jobs"
              className="text-gray-300 hover:text-teal-400 transition-colors duration-300 relative group cursor-pointer whitespace-nowrap"
            >
              공고 찾기
            ...
            <a
              href="/my-projects"
              className="text-teal-400 font-semibold relative group cursor-pointer whitespace-nowrap"
            >
              내 프로젝트
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-teal-100 rounded-full flex items-center justify-center">
                <span className="text-sm font-semibold text-teal-600">김</span>
              </div>
